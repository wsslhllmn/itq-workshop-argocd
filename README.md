...
1.  First step is to open this repository, **[click here](https://github.com/Men-io/argocd-training.git)**.\
    Change in this repository all url's from https://github.com/Men-io/argocd-training.git to the URL from the repository you forked (search with **ctrl + shift + f** or **cmd + shift + f**).\
...
12. Now it's time to apply a better setup for providing apps.\
    ...
    spec:
      ...
      generators:
        - git:
            repoURL: https://github.com/Men-io/argocd-training.git
